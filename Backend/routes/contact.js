...
router.post('/feedback', [
  ...
  try {
    ...
    try {
      await sendEmail({
        to: process.env.FEEDBACK_EMAIL || 'feedback@al_kohinoor-.com',
...
router.post('/availability-check', [
  ...
  try {
    ...
    try {
      await sendEmail({
        to: process.env.SALES_EMAIL || 'sales@al_kohinoor-.com',
...
router.get('/departments', (req, res) => {
  const departments = {
    general: {
      ...
      email: process.env.CONTACT_EMAIL || 'contact@al_kohinoor-.com',
      phone: process.env.CONTACT_PHONE || '+1-800-al_kohinoor',
      responseTime: '24-48 hours'
    },
    sales: {
      name: 'Sales & New Service',
      email: process.env.SALES_EMAIL || 'sales@al_kohinoor-.com',
      phone: process.env.SALES_PHONE || '+1-800-al_kohinoor',
      responseTime: '2-4 hours'
    },
    technical: {
      name: 'Technical Support',
      email: process.env.TECH_EMAIL || 'tech@al_kohinoor-.com',
      phone: process.env.TECH_PHONE || '+1-800-al_kohinoor',
      responseTime: '1-2 hours'
    },
    billing: {
      name: 'Billing & Payments',
      email: process.env.BILLING_EMAIL || 'billing@al_kohinoor-.com',
      phone: process.env.BILLING_PHONE || '+1-800-al_kohinoor',
      responseTime: '4-8 hours'
    },
    support: {
      name: 'Customer Support',
      email: process.env.SUPPORT_EMAIL || 'support@al_kohinoor-.com',
      phone: process.env.SUPPORT_PHONE || '+1-800-al_kohinoor',
      responseTime: '2-4 hours'
    }
  };
  ...
  res.json({
    ...
    emergencySupport: {
      available: true,
      phone: process.env.EMERGENCY_PHONE || '+1-800-al_kohinoor',
