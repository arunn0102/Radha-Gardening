...
const emailTemplates = {
  welcome: (data) => ({
    subject: 'Welcome to al_kohinoor !',
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h2 style="color: #2563eb;">Welcome to al_kohinoor !</h2>
        <p>Hi ${data.name},</p>
        <p>Thank you for registering with al_kohinoor ! We're excited to have you as part of our community.</p>
        ...
        <p>Best regards,<br>The al_kohinoor  Team</p>
      </div>
    `
  }),
  ...
  'ticket-status-update': (data) => ({
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <p>Best regards,<br>The al_kohinoor  Support Team</p>
      </div>
    `
  }),
  ...
  'inquiry-confirmation': (data) => ({
    subject: 'Thank you for contacting al_kohinoor ',
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
  ...
  'availability-confirmation': (data) => ({
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <p>Best regards,<br>The al_kohinoor  Sales Team</p>
      </div>
    `
  })
};
...
const sendEmail = async ({ to, subject, template, data }) => {
  try {
    ...
    const info = await transporter.sendMail({
      from: `"al_kohinoor " <${process.env.EMAIL_USER}>`,
      to: to,
...
const testEmail = async () => {
  try {
    await sendEmail({
      ...
      subject: 'Test Email from al_kohinoor  Backend',
      template: 'welcome',
      data: {
        name: 'Test User',
